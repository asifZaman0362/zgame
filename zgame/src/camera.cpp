...
glm::mat4 Camera::get_view_matrix() {
    ...
    if (projection == Perspective) {
        ...
        proj = glm::ortho(m_ortho_bounds.x, m_ortho_bounds.y, m_ortho_bounds.z, m_ortho_bounds.w);
    }
    glm::mat4 matrix = glm::translate(glm::scale(glm::mat4(1.0f), m_scale), -m_translation);
