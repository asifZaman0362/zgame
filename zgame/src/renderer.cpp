...
void Renderer<PbrMaterial>::Update(float) {
    ...
    for (auto entity : m_entities) {
        ...
        auto specular_map = material->specular_map;
        auto smoothness = material->smoothness;
        auto roughness_map = material->roughness_map;
        auto displacement_map = material->displacement_map;
        ...
        shader::SetUniform(shader, "viewPos", camera_position);
        ...
        shader::SetUniform(shader, "mat.diffuseMap", glm::vec<1, int>(0));
        shader::SetUniform(shader, "mat.normalMap", glm::vec<1, int>(1));
        //shader::SetUniform(shader, "mat.diffuse", diffuse);
        shader::SetUniform(shader, "mat.metallicMap", glm::vec<1, int>(2));
        shader::SetUniform(shader, "mat.roughnessMap", glm::vec<1, int>(3));
        /*shader::SetUniform(shader, "mat.smoothness", glm::vec<1, float>(smoothness));
        shader::SetUniform(shader, "mat.specular", glm::vec<1, float>(specular_intensity));
        */
